...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 4px; overflow: hidden;">
    ...
    <tr>
        <td style="padding: 40px 30px; color: #1a1a1a; line-height: 1.6;">
            ...
            <!-- Nút Đặt lại mật khẩu (Mình đổi màu chút xíu để cảnh báo) -->
            <div style="text-align: center; margin: 40px 0;">
                <a href="${link}" style="background-color: #fff3cd; color: #856404; padding: 14px 32px; text-decoration: none; border-radius: 4px; font-weight: bold; font-size: 16px; display: inline-block; border: 1px solid #ffeeba;">Đổi Mật Khẩu</a>
            </div>

            <p style="margin: 0 0 15px 0; font-size: 14px;">Liên kết này sẽ hết hạn trong vòng ${linkExpiration} phút. Nếu bạn không yêu cầu thay đổi mật khẩu, bạn có thể an tâm bỏ qua email này. Tài khoản của bạn vẫn an toàn.</p>
